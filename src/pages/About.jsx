...
const About = () => {
  return (
    ...
    <div>
       ...
       <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent justify-between gap-10 text-white text-center' >
         <header className='mx-auto py-20 text-4xl font-semibold '>
        ...
        <div className='sm:h-[70px] lg:h-[150px]'></div>
          <div className='absolute bottom-0 left-1/2 w-full -translate-x-1/2 translate-y-[30%] grid-cols-3 gap-3 lg:gap-5 flex flex-row '>
      ...
      <div className='mx-auto w-11/12 max-w-maxContent flex flex-col justify-between gap-10 text-richblack-500'>
          ...
          <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
            <div className='my-24 lg:w-[40%] flex-col gap-10'>
              ...
              <p className='text-base font-medium text-richblack-300 lg:w-[95%] mt-4'>
            ...
            <div className='my-24 lg:w-[40%] flex-col gap-10'>
              ...
              collaborate, and learn from one another. We believe that knowledge thrives in an environment of sharing and dialogue, 
