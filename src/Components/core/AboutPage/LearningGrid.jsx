    ...
    <div className="grid mx-auto w-[350px] xl:w-fit grid-cols-1 xl:grid-cols-4 mb-12">
      {LearningGridArray.map((card,i)=>{
        return (
            ...
            ${card.order %2===1 ? "bg-richblack-700 ":card.order % 2 === 0
            ? "bg-richblack-800 h-[294px]"
            : "bg-transparent"}  ${card.order===3  && "xl:col-start-2"}`}>
                {
                    card.order<0 ? (
                    <div className='flex flex-col xl:w-[90%] pb-10'>
                    <div className='text-2xl font-semibold mt-4 leading-[1.475]'>
                    <span className='text-white'>{card.heading}</span> 
